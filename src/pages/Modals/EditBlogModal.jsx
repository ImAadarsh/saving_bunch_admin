...
const EditBlogModal = ({ data, setRefreshFlag, refreshFlag, notify }) => {
  const { updateOffer, deleteBlogImage } = useMain();
  ...
  //   const ans = await deleteBlogImage(prevImage.id);
  //   console.log(ans);
  //   if (ans.status) {
  //     setPrevImage('');
  //   }
  ...
  const handleSubmit = async (e) => {
    ...
    const ans = await updateOffer({ ...value });
            ...
            <div className="p-6 space-y-6">
              <form onSubmit={handleSubmit}>
                <div className="bus-form">
                  <h4 className="text-xl text-center mb-4 font-bold">Edit offer details</h4>
                  ...
                  <div className="grid gap-6 px-0.5 py-0.5 mb-6 md:grid-cols-2">
                    <div>
                      ...
                      <input type="text" id="startDate" name="startDate" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-purple-500 focus:border-blue-500 block w-full p-2.5 " placeholder="Enter Start Date .." onChange={handleChange} value={value.startDate} required />
                    </div>
                    <div>
                      <label htmlFor="endDate" className="block mb-2 text-sm font-medium text-gray-900 ">End Date</label>
                      <input type="text" id="endDate" name='endDate' className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-purple-500 focus:border-blue-500 block w-full p-2.5 " placeholder="Enter End Date .." onChange={handleChange} value={value.endDate} required />
                    </div>

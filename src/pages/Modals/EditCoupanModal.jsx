...
const EditCoupanModal = (props) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const ans = await updateCoupan({ ...value, user: users.find(x => x._id === value.user) });
    console.log(ans);
    if (ans.status) {
      setValue({
        store: '',
              ...
              <form onSubmit={handleSubmit}>
                <div className="bus-form">
                  ...
                  <div className="grid gap-6 px-0.5 py-0.5 mb-6 md:grid-cols-2">
                    ...
                    <div>
                      <label htmlFor="category" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select an user</label>

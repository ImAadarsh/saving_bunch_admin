...
const EditBannerModal = (props) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const ans = await updateBanner(value);
    console.log(ans);
    if (ans.status) {
      setValue({
        sequence: '',
  ...
  return (
    <>
      <div id="editBannerModal" tabIndex="-1" className="fixed cus-modal top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full">

...
const Store = ({ notify }) => {
    ...
    },    
    {
      ...
      selector: row => <div className="flex justify-center">
        <div onClick={() => {
          ...
          navigate(`/store-details/${row._id}`);
        ...
        <div onClick={() => {
          setId(row._id);
          setMsg("Are you sure you want to delete selected store?");
  ...
  //       {data.subStore.map((e,index)=>{
  //         return (
  //           <li className="w-full px-4 py-2 border-b border-gray-200 dark:border-gray-600">
  //             <div>Store: {e.coupanCode}</div>
  ...
  return (
    <>
      <AddStoreModal setRefreshFlag={setRefreshFlag} refreshFlag={refreshFlag} notify={notify} />
      <EditStoreModal data1={data1} setRefreshFlag={setRefreshFlag} refreshFlag={refreshFlag} notify={notify} />
      ...
      <DefaultLayout>
        <div className='text-right mb-3'>
          ...
          }} className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Add Stores +</button>
        </div>
